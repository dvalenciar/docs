...
<Warning>
    ReinforceUI Studio is designed to for environments and algorithms
    for **CONTINUOUS ACTION SPACE** only.

    Which this means? So, it is not suitable for environments such as Atari games or discrete control
