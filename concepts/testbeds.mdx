...
<CardGroup cols="2">
  <Card title="Algorithms" icon="sparkles" href="/algorithms/algorithm_list">
    Check the Algorithms Included on ReiforceUI-Studio
  </Card>

  <Card title="Installation" icon="sparkles" href="/user_guides/installation">
